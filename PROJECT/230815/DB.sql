...
-- 호스트 INSERT
INSERT INTO HOST
VALUES('host456','df','123456','sdf','010-0000-0000','010-1111-1111','여성','hohoho@naver.com','123','사진'
,SYSDATE,SYSDATE,SYSDATE);
...
INSERT INTO ROOM
VALUES (SEQ_ROOM_rm_no.NEXTVAL, 'host123', '코지하우스', 4, 150000,'cozy.jpg', '오션뷰', '체크인 시간 1시 체크아웃 2시입니다~~ 좋지요?', 0, 0,'제주특별자치도','조천읍','이미지2','이미지3');
INSERT INTO ROOM
...
INSERT INTO CART
VALUES(SEQ_CART_cno.NEXTVAL,5,'IAM','2023-08-17','2023-08-26',4);
...
INSERT INTO YEYAK
VALUES('15151','IAM','host123',3,'1111','2023-08-26','2023-08-29','3');

-- 결제정보 payment
INSERT INTO PAYMENT
VALUES('1111','신한','2020-3030-44',122222,'2023-08-07','');
...
SELECT r.img, r.rm_name, r.price, y.yno,y.ye_checkin, y.ye_checkout, y.ye_guest
FROM yeyak y
JOIN room r
 ON y.rm_no = r.rm_no
WHERE mid = 'IAM'
...
DROP TRIGGER payment_cancel_trigger;
