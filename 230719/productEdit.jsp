				...
				for(ProductVO pvo : proList) {%>
					<div class="col-md-4">
						...
						<c:if test="${param.edit =='modify'}">
							<p><a href="productModify.jsp?edit=modify&pid=<%=pvo.getPid()%>"class="btn btn-info modifyBtn">수정 &raquo;</a></p>
						</c:if>
				 	...
				 	<!-- 여기에다가 파라미터로 모든 값을 보내면 주소창이 복잡해진다.
				 			파라미터를 보낼 때 post로 하든가, 아님 다른 방법 찾아보기. -->
			<% 	}
